...
if ($edit) {
    $page->title = "Изменение кафедры";
}
else {
    $page->title = "Добавление кафедры";
}
...
<div class="col-12 m-auto vh-80 d-flex flex-column justify-content-center">
    <div>
        <h1 class="h3 text-center mb-5"><?php if ($edit) : ?>Изменение кафедры<?php else : ?>Добавление кафедры<?php endif; ?></h1>

        <form action="/departments/<?php if ($edit) : ?>edit<?php else : ?>add<?php endif; ?>/" method="post">
            <div class="form-row">
                <div class="col-5 m-auto mt-3">
                    <label for="name">Название кафедры <span class="color-red">*</span>:</label>
                    <div class="input-group">
                        <input name="name" type="text" id="name" placeholder="Кафедра инфокогниетивных технологий"
